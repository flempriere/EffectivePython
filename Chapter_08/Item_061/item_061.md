...
```
    ...
    * Called __getattribute__('_data')
    ...
    Cell In[8], line 9
          ...
          8 data = BrokenDictionaryRecord({"foo": 3})
    ----> 9 data.foo

    Cell In[8], line 6, in BrokenDictionaryRecord.__getattribute__(self, name)
          4 def __getattribute__(self, name):
          5     print(f"* Called __getattribute__({name!r})")
    ----> 6     return self._data[name]
    ...
    ----> 6     return self._data[name]
        ...
        [... skipping similar frames: BrokenDictionaryRecord.__getattribute__ at line 6 (2971 times)]
    ...
    File ~/work/EffectivePython/EffectivePython/.venv/lib/python3.14/site-packages/IPython/core/interactiveshell.py:3111, in InteractiveShell._tee.<locals>.write(data, *args, **kwargs)
       3109     return result
       3110 output_stream = None
    -> 3111 outputs_by_counter = self.history_manager.outputs
       3112 output_type = "out_stream" if channel == "stdout" else "err_stream"
       3113 if execution_count in outputs_by_counter:

    File ~/work/EffectivePython/EffectivePython/.venv/lib/python3.14/site-packages/traitlets/traitlets.py:687, in TraitType.__get__(self, obj, cls)
        685     return self
        686 else:
    --> 687     return t.cast(G, self.get(obj, cls))

    File ~/work/EffectivePython/EffectivePython/.venv/lib/python3.14/site-packages/traitlets/traitlets.py:666, in TraitType.get(self, obj, cls)

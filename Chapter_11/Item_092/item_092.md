...
```
             ...
             41802 function calls (41798 primitive calls) in 4.028 seconds

       Ordered by: cumulative time

       ncalls  tottime  percall  cumtime  percall filename:lineno(function)
            4    0.000    0.000    4.027    1.007 base_events.py:1977(_run_once)
        20736    3.993    0.000    4.021    0.000 2565863959.py:10(insert_value)
            1    0.001    0.001    3.869    3.869 2565863959.py:7(<lambda>)
            1    0.004    0.004    3.334    3.334 2565863959.py:18(insertion_sort)
            3    0.001    0.000    0.158    0.053 selectors.py:435(select)
    ...
    <pstats.Stats at 0x7fc6ecba5e80>
...
```
             ...
             62532 function calls (62528 primitive calls) in 0.045 seconds

       Ordered by: cumulative time

       ncalls  tottime  percall  cumtime  percall filename:lineno(function)
        20736    0.007    0.000    0.041    0.000 2000139989.py:11(insert_value)
            2    0.000    0.000    0.034    0.017 base_events.py:1977(_run_once)
            1    0.000    0.000    0.034    0.034 2000139989.py:8(<lambda>)
            1    0.002    0.002    0.034    0.034 2000139989.py:16(insertion_sort)
        20736    0.027    0.000    0.027    0.000 {method 'insert' of 'list' objects}
            ...
            7    0.001    0.000    0.010    0.001 socket.py:623(send)
    ...
    <pstats.Stats at 0x7fc6ecc12350>
...
```
             ...
             20749 function calls (20744 primitive calls) in 0.084 seconds

       Ordered by: cumulative time

       ncalls  tottime  percall  cumtime  percall filename:lineno(function)
        20200    0.066    0.000    0.066    0.000 3007661153.py:5(utility)
    ...
    <pstats.Stats at 0x7fc6ecc12710>
...
```
    ...
    3101860672.py:5(utility)                              <- 18529/766    0.063    0.003  3101860672.py:11(first_function)
                                                                 200    0.000    0.000  3101860672.py:16(second_function)
                                                            1216/240    0.004    0.001  selectors.py:435(select)
                                                             253/233    0.001    0.001  socket.py:700(send_multipart)
    3101860672.py:11(first_function)                      <-       0    0.000    0.000  3101860672.py:21(program)
                                                                  12    0.002    0.042  base_events.py:1977(_run_once)
                                                                   6    0.001    0.018  iostream.py:350(_really_send)
    3101860672.py:21(program)                             <-
    events.py:92(_run)                                    <-       1    0.000    0.026  3101860672.py:11(first_function)
                                                                   2    0.000    0.000  base_events.py:1977(_run_once)
    {method 'run' of '_contextvars.Context' objects}      <-       3    0.000    0.026  events.py:92(_run)
    zmqstream.py:573(_handle_events)                      <-       1    0.000    0.026  asyncio.py:206(_handle_events)
                                                                   1    0.000    0.000  zmqstream.py:684(<lambda>)
    asyncio.py:206(_handle_events)                        <-       1    0.000    0.026  {method 'run' of '_contextvars.Context' objects}
    zmqstream.py:614(_handle_recv)                        <-       2    0.000    0.026  zmqstream.py:573(_handle_events)
    zmqstream.py:546(_run_callback)                       <-       2    0.000    0.026  zmqstream.py:614(_handle_recv)
    iostream.py:229(_handle_event)                        <-       2    0.000    0.026  zmqstream.py:546(_run_callback)
    iostream.py:348(<lambda>)                             <-       2    0.000    0.026  iostream.py:229(_handle_event)
    iostream.py:350(_really_send)                         <-       2    0.000    0.026  iostream.py:348(<lambda>)
    ...
    3101860672.py:16(second_function)                     <-      13    0.000    0.000  base_events.py:1977(_run_once)
                                                                   7    0.000    0.000  iostream.py:350(_really_send)
    ...
    socket.py:623(send)                                   <-     9/6    0.000    0.000  3101860672.py:11(first_function)
                                                                 4/0    0.000    0.000  socket.py:700(send_multipart)
    ...
    <pstats.Stats at 0x7fc6ecbc0c30>
...
```
    ...
    3103966480.py:11(first_function)                      -> 18803/762    0.062    0.003  3103966480.py:5(utility)
    ...
    3103966480.py:21(program)                             ->       0    0.000    0.000  3103966480.py:11(first_function)
                                                                   2    0.000    0.013  base_events.py:1977(_run_once)
                                                                   1    0.000    0.000  {method 'disable' of '_lsprof.Profiler' objects}
    base_events.py:1977(_run_once)                        ->      16    0.003    0.054  3103966480.py:11(first_function)
                                                                  17    0.000    0.000  3103966480.py:16(second_function)
    ...
    zmqstream.py:614(_handle_recv)                        ->       2    0.000    0.000  socket.py:771(recv_multipart)
                                                                   2    0.000    0.010  zmqstream.py:546(_run_callback)
    ...
    socket.py:700(send_multipart)                         ->     237    0.001    0.001  3103966480.py:5(utility)
                                                                   9    0.000    0.000  enum.py:1583(__or__)
                                                                 9/2    0.000    0.000  socket.py:623(send)
                                                                  14    0.000    0.000  {built-in method builtins.isinstance}
    selectors.py:435(select)                              -> 958/356    0.003    0.001  3103966480.py:5(utility)
    ...
    <pstats.Stats at 0x7fc6ecbc08a0>

...
```
    ...
    Before: 87919
    After:    97994
    <__main__.MyObject object at 0x7fb6608a9c20>
    <__main__.MyObject object at 0x7fb6608a9c70>
    <__main__.MyObject object at 0x7fb6608a9cc0>
...
```
    ...
    /tmp/ipykernel_14140/1425524081.py:11: size=1299 KiB (+1299 KiB), count=10000 (+10000), average=133 B
    /tmp/ipykernel_14140/1425524081.py:17: size=785 KiB (+785 KiB), count=10000 (+10000), average=80 B
    /tmp/ipykernel_14140/1425524081.py:18: size=84.4 KiB (+84.4 KiB), count=100 (+100), average=864 B
...
```
    ...
    Biggest offender is:
      ...
      File "/tmp/ipykernel_14140/1838260187.py", line 27
        waste_memory = run()
      File "/tmp/ipykernel_14140/1838260187.py", line 23
        deep_values.append(get_data())
      File "/tmp/ipykernel_14140/1838260187.py", line 15
        obj = MyObject()
      File "/tmp/ipykernel_14140/1838260187.py", line 9
        self.data = os.urandom(1000)
...
- For more complex use cases consider community tools

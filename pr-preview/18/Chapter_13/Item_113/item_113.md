...
```
    ...
    Traceback (most recent call last):
      File "/tmp/ipykernel_14037/4259668897.py", line 9, in test_equal
        self.assertEqual(1.667, n / d)  # Raises
        ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^
    ...
    <unittest.main.TestProgram at 0x7fcef847eba0>
...
```
    ...
    <unittest.main.TestProgram at 0x7fcef84ebed0>
...
```
    ...
    <unittest.main.TestProgram at 0x7fcef84ea490>

...
- The previous solutions to parallel I/O we've examined, have all fundamentally relied on *threads* (See [Item 72](../Item_072/item_072.qmd), [Item 73](../Item_073/item_073.qmd) and [Item 74](../Item_074/item_074.qmd))
...
- Coroutines are implemented via the `async` and `await` keywords
    - Generators are a form of coroutine (See [Item 43](../../Chapter_06/Item_043/item_043.qmd) and [Item 47](../../Chapter_06/Item_047/item_047.qmd))

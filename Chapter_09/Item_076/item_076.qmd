...
- Given the cleanliness of coroutines (See [Item 75](../Item_075/item_075.qmd)), how does one port existing *threaded* concurrency to use `aysnc`?
...
- Standard implementation for a client/server is to use threads (See [Item 68](../Item_068/item_068.qmd)) to handle blocking I/O
...
- We then run a game using a context manager via a `with` statement (See [Item 82](../../Chapter_10/Item_082/item_082.qmd))
...
- Not always as straightforward to convert
    ...
    - Worth considering looking for third party libraries where friction occurs (See [Item 116](../../Chapter_14/Item_116/item_116.qmd))

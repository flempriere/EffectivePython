...
```
    ...
    File ~/.local/share/uv/python/cpython-3.14.3-linux-x86_64-gnu/lib/python3.14/concurrent/futures/thread.py:86, in _WorkItem.run(self, ctx)
         83     return
         85 try:
    ...
    File ~/.local/share/uv/python/cpython-3.14.3-linux-x86_64-gnu/lib/python3.14/concurrent/futures/thread.py:73, in WorkerContext.run(self, task)

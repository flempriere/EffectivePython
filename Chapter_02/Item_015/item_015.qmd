---
title: "Item 15: Avoid Striding and Slicing in a Single Expression"
---

## Notes

- Python *slices* (See [Item 14](../Item_014/item_014.qmd)) can be extended with a *stride*
...
- Also works for unicode strings (See [Item 10](../../Chapter_02/Item_010/item_010.qmd))
...
- Striding + slicing results in an additional shallow copy
    ...
    - If this is still too memory intensive consider the `itertools` module
        - Provides `islice` which is a cleaner interface (See [Item 24](../../Chapter_03/Item_024/item_024.qmd))

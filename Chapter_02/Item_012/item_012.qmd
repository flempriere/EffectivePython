---
title: "Item 12: Understand the Difference Between `repr` and `str` when Printing Objects"
---

## Notes

- `print` statement style debugging refers to debugging via format strings or `logging` (See [Item 11](../Item_011/item_011.qmd))
    - Tend's to get you pretty far
    - Consider a proper debugger for more complicated issues (See [Item 114](../../Chapter_13/Item_114/item_114.qmd))
- Python object internals are typically public and accessible via attributes (See [Item 55](../../Chapter_07/Item_055/item_055.qmd))
- `print` returns a human readable string
    - Can be customised via formatting (see [Item 11](../Item_011/item_011.qmd))
...
- `repr` built-in returns the *printable representation* on an object
    ...
    - i.e we can `eval` it to get the object back (avoid using `eval` in practice. See [Item 91](../../Chapter_10/Item_091/item_091.qmd))
...
- When `str` is called on an argument
    ...
    3. If neither exists, goes through method resolution (See [Item 53](../../Chapter_07/Item_053/item_053.qmd))
...
- A lightweight `repr` implementation may be, (See [Item 51](../../Chapter_07/Item_051/item_051.qmd))

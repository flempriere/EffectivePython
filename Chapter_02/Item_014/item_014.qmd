...
- Slicing can be extended to any class implementing the `__getitem__` and `__setitem__` dunder methods (See [Item 57](../../Chapter_07/Item_057/item_057.qmd))
...
- Slicing a list creates a new list (See [Item 2](../../Chapter_01/Item_002/item_002.qmd) and [Item 16](../Item_016/item_016.qmd))

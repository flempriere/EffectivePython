...
- Slice is implemented by default for sequence types (`list`, `tuple`,
  `str`, `bytes`)
...
- When slicing to the end you should omit the last index (last is
  assumed by default)
...
- Negative indices let you slice offset relative to the end of the
  sequence
  - A python reader should be able to understand all of the following
    slices
...
> [!NOTE]
>
> Indexing by a negated variable can lead to surprising results. E.g.

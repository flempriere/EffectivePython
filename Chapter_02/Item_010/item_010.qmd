...
- The `%` operator works with format strings for both (See [Item 11](../Item_011/item_011.qmd))
...
- However, the code doesn't behave as expected
    - The `bytes` text is converted to its `__repr__` i.e. the string `"b'text'"` (see [Item 12](../Item_012/item_012.qmd))

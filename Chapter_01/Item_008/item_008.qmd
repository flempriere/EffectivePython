...
- Here we effectively duplicate `count`, because we assign then test it
    ...
    - People will try and create workarounds (See [Item 4](../Item_004/item_004.qmd) and [Item 7](../Item_007/item_007.qmd))
...
- Could instead put the pieces assignment in an `else` clause with the `if`
    ...
    - Works because of python's scoping rules (See [Item 33](../../Chapter_05/Item_033/item_033.qmd)), but easy to break if code changes around it
...
- We can use the walrus operator to flatten this structure (See [Item 9](../Item_009/item_009.qmd))
...
- See [Item 42](../../Chapter_06/Item_042/item_042.qmd) for more examples of using assignment expressions

---
title: "Item 4: Write Helper Functions instead of Complex Expressions"
---
...
- In the `"opacity"` case, opacity is not in the dictionary
    - `get` returns `[""]` (See [Item 26](../../Chapter_04/Item_026/item_026.qmd))
...
- Could use an inline `if` but there's not much more clarity (See [Item 7](../Item_007/item_007.qmd))

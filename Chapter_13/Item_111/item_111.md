...
```
    ...
    Expected: mock(<object object at 0x7fdc64565860>, 'Meerkat')
      Actual: mock(<object object at 0x7fdc64565860>, 'Eagle')
    ---------------------------------------------------------------------------
...
```
    ...
    Outside patch: <function get_animals at 0x7fdc643aafb0>
    Inside patch <MagicMock name='get_animals' id='140584557041984'>
    After patch: <function get_animals at 0x7fdc643aafb0>
...
```
    ...
    Now outside patch: 2026-06-05 16:35:11.342609
    Now inside patch: 2024-06-05 15:45:00
    Now back outside patch: 2026-06-05 16:35:11.342975

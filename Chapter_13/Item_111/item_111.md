...
```
    ...
    Expected: mock(<object object at 0x7f0b4cf5d860>, 'Meerkat')
      Actual: mock(<object object at 0x7f0b4cf5d860>, 'Eagle')
    ---------------------------------------------------------------------------
...
```
    ...
    Outside patch: <function get_animals at 0x7f0b4cda2c40>
    Inside patch <MagicMock name='get_animals' id='139686769318544'>
    After patch: <function get_animals at 0x7f0b4cda2c40>
...
```
    ...
    Now outside patch: 2026-05-31 12:17:10.014583
    Now inside patch: 2024-06-05 15:45:00
    Now back outside patch: 2026-05-31 12:17:10.015054

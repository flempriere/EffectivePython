...
```
    ...
    Traceback (most recent call last):
      File "/tmp/ipykernel_13853/4259668897.py", line 9, in test_equal
        self.assertEqual(1.667, n / d)  # Raises
        ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^
    ...
    <unittest.main.TestProgram at 0x7fcb40ce2ba0>
...
```
    ...
    <unittest.main.TestProgram at 0x7fcb40f47ed0>
...
```
    ...
    <unittest.main.TestProgram at 0x7fcb40f46490>

...
```
    ...
    Traceback (most recent call last):
      File "/tmp/ipykernel_13633/4259668897.py", line 9, in test_equal
        self.assertEqual(1.667, n / d)  # Raises
        ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^
    ...
    <unittest.main.TestProgram at 0x7f7a342facf0>
...
```
    ...
    <unittest.main.TestProgram at 0x7f7a3436bed0>
...
```
    ...
    <unittest.main.TestProgram at 0x7f7a3436a490>

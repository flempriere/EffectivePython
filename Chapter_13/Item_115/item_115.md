...
```
    ...
    Before: 87905
    After:    97980
    <__main__.MyObject object at 0x7f0fa4df5d10>
    <__main__.MyObject object at 0x7f0fa4df5d60>
    <__main__.MyObject object at 0x7f0fa4df5db0>
...
```
    ...
    /tmp/ipykernel_14217/1425524081.py:11: size=1299 KiB (+1299 KiB), count=10000 (+10000), average=133 B
    /tmp/ipykernel_14217/1425524081.py:17: size=785 KiB (+785 KiB), count=10000 (+10000), average=80 B
    /tmp/ipykernel_14217/1425524081.py:18: size=84.4 KiB (+84.4 KiB), count=100 (+100), average=864 B
...
```
    ...
    Biggest offender is:
      ...
      File "/tmp/ipykernel_14217/1838260187.py", line 27
        waste_memory = run()
      File "/tmp/ipykernel_14217/1838260187.py", line 23
        deep_values.append(get_data())
      File "/tmp/ipykernel_14217/1838260187.py", line 15
        obj = MyObject()
      File "/tmp/ipykernel_14217/1838260187.py", line 9
        self.data = os.urandom(1000)

---
title: "Item 21: Be Defensive when Iterating Over Arguments"
---
...
- To scale this up use a generator from a file (See [Item 43](../../Chapter_06/Item_043/item_043.qmd))
...
- We wrote the generator approach to avoid having to load the entire dataset into memory in the first place! (See [Item 115](../../Chapter_13/Item_115/item_115.qmd))
...
- Alternatively can import the `Iterator` class from the abstract collections built-in module (`collections.abc`) (See [Item 57](../../Chapter_07/Item_057/item_057.qmd))
...
- Can also extend this approach to asynchronous iterators (See [Item 76](../../Chapter_09/Item_076/item_076.qmd))

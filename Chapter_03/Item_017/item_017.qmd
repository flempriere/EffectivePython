...
- The `enumerate` built-in manages this for us
    - Wraps any iterator with a lazy generator (See [Item 43](../../Chapter_06/Item_043/item_043.qmd))
...
- We can then use unpacking (See [Item 5](../../Chapter_01/Item_005/item_005.qmd)) to easily separate the components of the `enumerate` pair

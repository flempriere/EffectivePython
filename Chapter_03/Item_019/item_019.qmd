...
- Why?
    - `else` in an `if/elif/else` construct only runs if neither preceding block does (See [Item 7](../../Chapter_01/Item_007/item_007.qmd))
    - `else` in a `try...except...else` only runs if no exception is thrown (See [Item 80](../../Chapter_10/Item_080/item_080.qmd))

...
- We can find a solution for this specific example
  - There are alternate techniques (See [Item
    19](../Item_019/item_019.qmd))
...
- Comprehensions and generator expressions do not leak their variables
  after execution (See [Item 40](../../Chapter_06/Item_040/item_040.qmd)
  and [Item 44](../../Chapter_06/Item_044/item_044.qmd))
...
- Assignment expressions in comprehensions can change this (See [Item
  42](../../Chapter_06/Item_042/item_042.qmd))
- Exception variables also don’t leak
  - But have their own quirks (See [Item
    84](../../Chapter_10/Item_084/item_084.qmd))
